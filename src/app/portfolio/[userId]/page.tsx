...
import ThemeJor1ProfilePage from "@/app/ThemesPortfolioCommon/Jonarlist/ThemeJor1/page";
import { Loader2 } from "lucide-react";

export default function PortfolioDynamicPage() {
  ...
  if (activeThemeId === INKWELL_ID) {
    return <ThemeJor1ProfilePage userId={userId} />;
  }
